...
import { LogIn, LoaderCircle, DatabaseZap } from "lucide-react";
...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        // Force refresh to re-evaluate middleware state
      ...
      <div className="w-full max-w-sm rounded-[2rem] border border-zinc-800/60 bg-zinc-900/40 p-8 shadow-2xl backdrop-blur-xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-zinc-400">
            Sign in to Oraya Database to manage your API keys and data schemas.
          </p>
        </div>
